(async () => {
  ...
  (function(e) {
    ...
    function r(L) {
      ...
      if (P !== _) {
        L[0] = P;
        e: for (var R = 0, T = L.length, Y = T >>> 1; R < Y; ) {
    ...
    var a = [], c = [], h = 1, g = null, v = 3, b = false, k = false, p = false, N = typeof setTimeout == "function" ? setTimeout : null, m = typeof clearTimeout == "function" ? clearTimeout : null, d = typeof setImmediate < "u" ? setImmediate : null;
    ...
    function w(L) {
      if (p = false, f(L), !k) if (n(a) !== null) k = true, dt(j);
        ...
        var _ = n(c);
        _ !== null && Tn(w, _.startTime - L);
      }
    }
    function j(L, _) {
      k = false, p && (p = false, m(C), C = -1), b = true;
      var P = v;
      try {
        for (f(_), g = n(a); g !== null && (!(g.expirationTime > _) || L && !G()); ) {
          var R = g.callback;
        ...
        if (g !== null) var Y = true;
        else {
          var Z = n(c);
          Z !== null && Tn(w, Z.startTime - _), Y = false;
        }
        return Y;
      } finally {
        g = null, v = P, b = false;
    ...
    var S = false, x = null, C = -1, O = 5, M = -1;
    function G() {
    ...
    var Pe;
    if (typeof d == "function") Pe = function() {
      d(be);
    };
    else if (typeof MessageChannel < "u") {
      var Xt = new MessageChannel(), Jt = Xt.port2;
      Xt.port1.onmessage = be, Pe = function() {
        Jt.postMessage(null);
      };
    } else Pe = function() {
      N(be, 0);
    ...
    e.unstable_IdlePriority = 5, e.unstable_ImmediatePriority = 1, e.unstable_LowPriority = 4, e.unstable_NormalPriority = 3, e.unstable_Profiling = null, e.unstable_UserBlockingPriority = 2, e.unstable_cancelCallback = function(L) {
      ...
      return T = P + T, L = {
        ...
        expirationTime: T,
        sortIndex: -1
      }, P > R ? (L.sortIndex = P, t(c, L), n(a) === null && L === n(c) && (p ? (m(C), C = -1) : p = true, Tn(w, P - R))) : (L.sortIndex = T, t(a, L), k || b || (k = true, dt(j))), L;
    }, e.unstable_shouldYield = G, e.unstable_wrapCallback = function(L) {
      var _ = v;
      return function() {
        var P = v;
        v = _;
...
` + l[i].replace(" at new ", " at ");
  ...
  var Pu = Se.unstable_scheduleCallback, $s = Se.unstable_cancelCallback, sf = Se.unstable_shouldYield, af = Se.unstable_requestPaint, J = Se.unstable_now, uf = Se.unstable_getCurrentPriorityLevel, zi = Se.unstable_ImmediatePriority, _u = Se.unstable_UserBlockingPriority, dl = Se.unstable_NormalPriority, cf = Se.unstable_LowPriority, Lu = Se.unstable_IdlePriority, Ol = null, Ye = null;
  function df(e) {
  ...
  function An(e, t) {
    e.blockedOn === t && (e.blockedOn = null, Go || (Go = true, Se.unstable_scheduleCallback(Se.unstable_NormalPriority, wf)));
  }
  function sr(e) {
    function t(l) {
      return An(l, e);
    ...
    Nu(function() {
      ...
      e: {
        ...
        if (v !== void 0) {
          ...
          for (var d = c, f; d !== null; ) {
            f = d;
            var w = f.stateNode;
            if (f.tag === 5 && w !== null && (f = w, m !== null && (w = lr(d, m), w != null && p.push(dr(d, w, f)))), N) break;
            d = d.return;
          }
          0 < p.length && (v = new b(v, k, null, n, h), g.push({
            event: v,
            listeners: p
          }));
        }
      ...
      if (!(t & 7)) {
        e: {
          ...
          if ((b || v) && (v = h.window === h ? h : (v = h.ownerDocument) ? v.defaultView || v.parentWindow : window, b ? (k = n.relatedTarget || n.toElement, b = c, k = k ? It(k) : null, k !== null && (N = Yt(k), k !== N || k.tag !== 5 && k.tag !== 6) && (k = null)) : (b = null, k = c), b !== k)) {
            if (p = Hs, w = "onMouseLeave", m = "onMouseEnter", d = "mouse", (e === "pointerout" || e === "pointerover") && (p = Ks, w = "onPointerLeave", m = "onPointerEnter", d = "pointer"), N = b == null ? v : on(b), f = k == null ? v : on(k), v = new p(w, d + "leave", b, n, h), v.target = N, v.relatedTarget = f, w = null, It(h) === c && (p = new p(m, d + "enter", k, n, h), p.target = f, p.relatedTarget = N, w = p), N = w, b && k) t: {
              for (p = b, m = k, d = 0, f = p; f; f = Zt(f)) d++;
              for (f = 0, w = m; w; w = Zt(w)) f++;
              for (; 0 < d - f; ) p = Zt(p), d--;
              for (; 0 < f - d; ) m = Zt(m), f--;
              for (; d--; ) {
            ...
            b !== null && ra(g, v, b, p, false), k !== null && N !== null && ra(g, N, k, p, true);
          }
        }
        e: {
        ...
        C && ($u && n.locale !== "ko" && (nn || C !== "onCompositionStart" ? C === "onCompositionEnd" && nn && (x = Du()) : (yt = h, $i = "value" in yt ? yt.value : yt.textContent, nn = true)), S = hl(c, C), 0 < S.length && (C = new Vs(C, e, null, n, h), g.push({
          event: C,
          listeners: S
        }), x ? C.data = x : (x = Uu(n), x !== null && (C.data = x)))), (x = Kf ? Qf(e, n) : Gf(e, n)) && (c = hl(c, "onBeforeInput"), 0 < c.length && (h = new Vs("onBeforeInput", "beforeinput", null, n, h), g.push({
          event: h,
          listeners: c
        }), h.data = x));
      }
...
`).replace(um, "");
  ...
  var an = [], un = 0, xl = null, wl = 0, _e = [], Le = 0, Ht = null, tt = 1, nt = "";
  function zt(e, t) {
    an[un++] = wl, an[un++] = xl, xl = e, wl = t;
  }
  function lc(e, t, n) {
    _e[Le++] = tt, _e[Le++] = nt, _e[Le++] = Ht, Ht = e;
    var r = tt;
    e = nt;
    var l = 32 - Be(r) - 1;
    r &= ~(1 << l), n += 1;
  ...
  function Ki(e) {
    ...
    for (; e === Ht; ) Ht = _e[--Le], _e[Le] = null, nt = _e[--Le], _e[Le] = null, tt = _e[--Le], _e[Le] = null;
  }
  ...
  function ua(e, t) {
    switch (e.tag) {
      case 5:
        var n = e.type;
        return t = t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase() ? null : t, t !== null ? (e.stateNode = t, Ne = e, je = jt(t.firstChild), true) : false;
      case 6:
    ...
    if (W) {
      ...
      if (t) {
        ...
        if (!ua(e, t)) {
          ...
          t = jt(n.nextSibling);
          var r = Ne;
          t && ua(e, t) ? oc(r, n) : (e.flags = e.flags & -4097 | 2, W = false, Ne = e);
        }
      } else {
        if (li(e)) throw Error(E(418));
  ...
  function Br(e) {
    ...
    var t;
    if ((t = e.tag !== 3) && !(t = e.tag !== 5) && (t = e.type, t = t !== "head" && t !== "body" && !ei(e.type, e.memoizedProps)), t && (t = je)) {
    ...
    } else je = Ne ? jt(e.stateNode.nextSibling) : null;
    return true;
  }
  function ic() {
  ...
  function sc(e) {
    ...
    function u(m, d, f, w) {
      return d === null || d.tag !== 6 ? (d = No(f, m.mode, w), d.return = m, d) : (d = l(d, f), d.return = m, d);
    }
    function a(m, d, f, w) {
      var j = f.type;
      return j === tn ? h(m, d, f.props.children, w, f.key) : d !== null && (d.elementType === j || typeof j == "object" && j !== null && j.$$typeof === pt && da(j) === d.type) ? (w = l(d, f.props), w.ref = Dn(m, d, f), w.return = m, w) : (w = ol(f.type, f.key, f.props, null, m.mode, w), w.ref = Dn(m, d, f), w.return = m, w);
    }
    function c(m, d, f, w) {
      return d === null || d.tag !== 4 || d.stateNode.containerInfo !== f.containerInfo || d.stateNode.implementation !== f.implementation ? (d = So(f, m.mode, w), d.return = m, d) : (d = l(d, f.children || []), d.return = m, d);
    }
    function h(m, d, f, w, j) {
      return d === null || d.tag !== 7 ? (d = Ut(f, m.mode, w, j), d.return = m, d) : (d = l(d, f), d.return = m, d);
    }
    function g(m, d, f) {
    ...
    function v(m, d, f, w) {
      ...
      if (typeof f == "string" && f !== "" || typeof f == "number") return j !== null ? null : u(m, d, "" + f, w);
      if (typeof f == "object" && f !== null) {
        switch (f.$$typeof) {
          case Fr:
            return f.key === j ? a(m, d, f, w) : null;
          case en:
            return f.key === j ? c(m, d, f, w) : null;
          case pt:
            return j = f._init, v(m, d, j(f._payload), w);
        }
        if (Hn(f) || On(f)) return j !== null ? null : h(m, d, f, w, null);
        Ur(m, f);
      }
      return null;
    }
    function b(m, d, f, w, j) {
      if (typeof w == "string" && w !== "" || typeof w == "number") return m = m.get(f) || null, u(d, m, "" + w, j);
      if (typeof w == "object" && w !== null) {
        switch (w.$$typeof) {
          case Fr:
            return m = m.get(w.key === null ? f : w.key) || null, a(d, m, w, j);
          case en:
            return m = m.get(w.key === null ? f : w.key) || null, c(d, m, w, j);
          case pt:
            var S = w._init;
            return b(m, d, f, S(w._payload), j);
        }
        if (Hn(w) || On(w)) return m = m.get(f) || null, h(d, m, w, j, null);
        Ur(d, w);
      }
      return null;
    }
    function k(m, d, f, w) {
      for (var j = null, S = null, x = d, C = d = 0, O = null; x !== null && C < f.length; C++) {
        ...
        e && x && M.alternate === null && t(m, x), d = o(M, d, C), S === null ? j = M : S.sibling = M, S = M, x = O;
      }
      if (C === f.length) return n(m, x), W && zt(m, C), j;
      if (x === null) {
        for (; C < f.length; C++) x = g(m, f[C], w), x !== null && (d = o(x, d, C), S === null ? j = x : S.sibling = x, S = x);
        return W && zt(m, C), j;
      }
      for (x = r(m, x); C < f.length; C++) O = b(x, m, C, f[C], w), O !== null && (e && O.alternate !== null && x.delete(O.key === null ? C : O.key), d = o(O, d, C), S === null ? j = O : S.sibling = O, S = O);
    ...
    function p(m, d, f, w) {
      ...
      for (var S = j = null, x = d, C = d = 0, O = null, M = f.next(); x !== null && !M.done; C++, M = f.next()) {
        x.index > C ? (O = x, x = null) : O = x.sibling;
        var G = v(m, x, M.value, w);
        if (G === null) {
          x === null && (x = O);
          break;
        }
        e && x && G.alternate === null && t(m, x), d = o(G, d, C), S === null ? j = G : S.sibling = G, S = G, x = O;
      }
      if (M.done) return n(m, x), W && zt(m, C), j;
      if (x === null) {
        for (; !M.done; C++, M = f.next()) M = g(m, M.value, w), M !== null && (d = o(M, d, C), S === null ? j = M : S.sibling = M, S = M);
        return W && zt(m, C), j;
      }
      for (x = r(m, x); !M.done; C++, M = f.next()) M = b(x, m, C, M.value, w), M !== null && (e && M.alternate !== null && x.delete(M.key === null ? C : M.key), d = o(M, d, C), S === null ? j = M : S.sibling = M, S = M);
        ...
        switch (f.$$typeof) {
          case Fr:
            e: {
              ...
              f.type === tn ? (d = Ut(f.props.children, m.mode, w, f.key), d.return = m, m = d) : (w = ol(f.type, f.key, f.props, null, m.mode, w), w.ref = Dn(m, d, f), w.return = m, m = w);
            }
            return i(m);
          case en:
            e: {
              ...
              d = So(f, m.mode, w), d.return = m, m = d;
            }
            return i(m);
          case pt:
            return S = f._init, N(m, d, S(f._payload), w);
        }
        if (Hn(f)) return k(m, d, f, w);
        if (On(f)) return p(m, d, f, w);
        Ur(m, f);
      }
      return typeof f == "string" && f !== "" || typeof f == "number" ? (f = "" + f, d !== null && d.tag === 6 ? (n(m, d.sibling), d = l(d, f), d.return = m, m = d) : (n(m, d), d = No(f, m.mode, w), d.return = m, m = d), i(m)) : n(m, d);
    }
    return N;
  }
        ...
        if ((r & v) === v) {
          ...
          e: {
            ...
            switch (v = t, b = n, p.tag) {
              ...
              case 0:
                if (k = p.payload, v = typeof k == "function" ? k.call(b, g, v) : k, v == null) break e;
                g = Q({}, g, v);
                break e;
              case 2:
                ht = true;
          ...
          callback: u.callback,
          next: null
        }, h === null ? (c = h = b, a = g) : h = h.next = b, i |= v;
        if (u = u.next, u === null) {
  ...
  var Cl = {
    ...
    useTransition: function() {
      var e = wo(gr)[0], t = Oe().memoizedState;
      return [
        e,
        t
      ];
    ...
    useTransition: function() {
      var e = bo(gr)[0], t = Oe().memoizedState;
      return [
        e,
        t
      ];
  ...
  function ai(e, t, n, r) {
    ...
    var o = t.contextType;
    typeof o == "object" && o !== null ? l.context = Te(o) : (o = xe(t) ? Wt : ce.current, l.context = wn(e, o)), l.state = e.memoizedState, o = t.getDerivedStateFromProps, typeof o == "function" && (si(e, t, o, n), l.state = e.memoizedState), typeof t.getDerivedStateFromProps == "function" || typeof l.getSnapshotBeforeUpdate == "function" || typeof l.UNSAFE_componentWillMount != "function" && typeof l.componentWillMount != "function" || (t = l.state, typeof l.componentWillMount == "function" && l.componentWillMount(), typeof l.UNSAFE_componentWillMount == "function" && l.UNSAFE_componentWillMount(), t !== l.state && Bl.enqueueReplaceState(l, l.state, null), jl(e, n, l, r), l.state = e.memoizedState), typeof l.componentDidMount == "function" && (e.flags |= 4194308);
  }
  function Nn(e, t) {
    try {
      var n = "", r = t;
...
` + o.stack;
  ...
  function Mc(e, t, n) {
    ...
    if (r.mode === "hidden") if (!(t.mode & 1)) t.memoizedState = {
      ...
      if (!(n & 1073741824)) return e = o !== null ? o.baseLanes | n : n, t.lanes = t.childLanes = 1073741824, t.memoizedState = {
        ...
        cachePool: null,
        transitions: null
      }, t.updateQueue = null, $(fn, ke), ke |= e, null;
      t.memoizedState = {
        baseLanes: 0,
        cachePool: null,
        transitions: null
      }, r = o !== null ? o.baseLanes : n, $(fn, ke), ke |= r;
    }
    else o !== null ? (r = o.baseLanes | n, t.memoizedState = null) : r = n, $(fn, ke), ke |= r;
  ...
  function ja(e, t, n, r, l) {
    ...
    if (vn(t, l), t.stateNode === null) nl(e, t), Fc(t, n, r), ai(t, n, r, l), r = true;
      ...
      typeof c == "object" && c !== null ? c = Te(c) : (c = xe(n) ? Wt : ce.current, c = wn(t, c));
  ...
  function Cm(e, t, n, r, l, o, i) {
    ...
    return l.data === "$?" ? (t.flags |= 128, t.child = e.child, t = Dm.bind(null, e), l._reactRetry = t, null) : (e = o.treeContext, je = jt(l.nextSibling), Ne = t, W = true, $e = null, e !== null && (_e[Le++] = tt, _e[Le++] = nt, _e[Le++] = Ht, tt = e.id, nt = e.overflow, Ht = t), t = ss(t, r.children), t.flags |= 4096, t);
  }
  function Sa(e, t, n) {
    e.lanes |= t;
    var r = e.alternate;
    ...
    switch (Ki(t), t.tag) {
      ...
      case 13:
        if (U(V), r = t.memoizedState, e === null || e.memoizedState !== null && e.memoizedState.dehydrated !== null) {
          if (W && je !== null && t.mode & 1 && !(t.flags & 128)) ic(), bn(), t.flags |= 98560, o = false;
      ...
      case 22:
      case 23:
        return fs(), r = t.memoizedState !== null, e !== null && e.memoizedState !== null !== r && (t.flags |= 8192), r && t.mode & 1 ? ke & 1073741824 && (ae(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : ae(t), null;
      case 24:
        return null;
      case 25:
        return null;
      ...
      if ("selectionStart" in e) var n = {
        ...
        if (r && r.rangeCount !== 0) {
          ...
          t: for (; ; ) {
            ...
            for (; ; ) {
              if (g === e) break t;
              if (v === n && ++c === l && (u = i), v === o && ++h === r && (a = i), (b = g.nextSibling) !== null) break;
              g = v, v = g.parentNode;
            }
            g = b;
          }
    ...
    for (qo = {
      ...
      try {
        ...
        if (t.flags & 1024) switch (t.tag) {
          ...
          case 1:
            if (k !== null) {
              var p = k.memoizedProps, N = k.memoizedState, m = t.stateNode, d = m.getSnapshotBeforeUpdate(t.elementType === t.type ? p : Ie(t.type, p), N);
  ...
  function Kc(e, t) {
    ...
    switch (e.tag) {
      ...
      case 13:
        ...
        break;
      case 22:
        if (h = n !== null && n.memoizedState !== null, e.mode & 1 ? (ue = (c = ue) || h, Ae(t, e), ue = c) : Ae(t, e), Ke(e), r & 8192) {
  ...
  var Tm = Math.ceil, El = ut.ReactCurrentDispatcher, as = ut.ReactCurrentOwner, Re = ut.ReactCurrentBatchConfig, A = 0, re = null, q = null, oe = 0, ke = 0, fn = Rt(0), te = 0, yr = null, Kt = 0, Wl = 0, us = 0, er = null, ge = null, cs = 0, Sn = 1 / 0, qe = null, Pl = false, xi = null, St = null, Vr = false, xt = null, _l = 0, tr = 0, wi = null, rl = -1, ll = 0;
  function fe() {
  ...
  function Qt(e) {
    ...
    try {
      ...
      I = r, Re.transition = n, A = t, !(A & 6) && Tt();
    }
  }
  function fs() {
    ke = fn.current, U(fn);
  ...
  function Bt(e, t) {
    ...
    if (re = e, q = e = Et(e.current, null), oe = ke = t, te = 0, yr = null, us = Wl = Kt = 0, ge = er = null, Dt !== null) {
  ...
  function At(e, t, n) {
    ...
    try {
      Re.transition = null, I = 1, Am(e, t, n, r);
    } finally {
      Re.transition = l, I = r;
    }
    return null;
  ...
  function Am(e, t, n, r) {
    ...
    if (vf(e, o), e === re && (q = re = null, oe = 0), !(n.subtreeFlags & 2064) && !(n.flags & 2064) || Vr || (Vr = true, td(dl, function() {
      ...
      I = 1;
      var u = A;
      A |= 4, as.current = null, Fm(e, n), Kc(n, e), rm(qo), ml = !!Zo, qo = Zo = null, e.current = n, Rm(n), af(), A = u, I = i, Re.transition = o;
    } else e.current = n;
  ...
  function yn() {
    if (xt !== null) {
      var e = Ru(_l), t = Re.transition, n = I;
      try {
        if (Re.transition = null, I = 16 > e ? 16 : e, xt === null) var r = false;
        else {
  ...
  ed = function(e, t, n) {
    ...
    switch (t.lanes = 0, t.tag) {
      ...
      case 3:
        e: {
          ...
          if (r = i.element, o.isDehydrated) if (o = {
            ...
            break e;
          } else for (je = jt(t.stateNode.containerInfo.firstChild), Ne = t, W = true, $e = null, n = ac(t, null, r, n), t.child = n; n; ) n.flags = n.flags & -3 | 4096, n = n.sibling;
          else {
            if (bn(), r === l) {
              t = at(e, t, n);
              break e;
      ...
      case 10:
        ...
        return t;
      case 9:
        return l = t.type, r = t.pendingProps.children, vn(t, n), l = Te(l), r = r(l), t.flags |= 1, de(e, t, r, n), t.child;
      case 14:
  ...
  function ol(e, t, n, r, l, o) {
    ...
    if (r = e, typeof e == "function") ps(e) && (i = 1);
      ...
      case Ri:
        ...
        break;
      case Ro:
        return e = Fe(12, n, t, l | 2), e.elementType = Ro, e.lanes = o, e;
      case To:
        return e = Fe(13, n, t, l), e.elementType = To, e.lanes = o, e;
      case Oo:
        return e = Fe(19, n, t, l), e.elementType = Oo, e.lanes = o, e;
      case du:
        return Hl(n, l, o, t);
      default:
  ...
  function Hl(e, t, n, r) {
    return e = Fe(22, e, r, t), e.elementType = du, e.lanes = n, e.stateNode = {
      isHidden: false
    }, e;
  }
  function No(e, t, n) {
  ...
  function hs(e, t, n, r, l, o, i, u, a) {
    return e = new Wm(e, t, n, u, a), t === 1 ? (t = 1, o === true && (t |= 8)) : t = 0, o = Fe(3, null, null, t), e.current = o, o.stateNode = e, o.memoizedState = {
      element: r,
      isDehydrated: n,
      cache: null,
      transitions: null,
  ...
  Ce.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Qm;
  ...
  function Rl(e, t) {
    ...
    return {
      params: r.reduce((c, { paramName: h, isOptional: g }, v) => {
        ...
        const b = u[v];
        return g && !b ? c[h] = void 0 : c[h] = (b || "").replace(/%2F/g, "/"), c;
      }, {}),
      pathname: o,
      pathnameBase: i,
      pattern: e
  ...
  function md(e, t, n, r) {
    ...
    let { navigator: l, static: o } = y.useContext(Ve), { matches: i } = y.useContext(Je), u = i[i.length - 1], a = u ? u.params : {}, c = u ? u.pathname : "/", h = u ? u.pathnameBase : "/", g = u && u.route;
    {
      let d = g && g.path || "";
...
Please change the parent <Route path="${d}"> to <Route path="${d === "/" ? "*" : `${d}/*`}">.`);
  ...
  function Dp(e, t = [], n = null, r = null) {
    ...
    return l.reduceRight((a, c, h) => {
      ...
      n && (g = o && c.route.id ? o[c.route.id] : void 0, b = c.route.errorElement || zp, i && (u < 0 && h === 0 ? (pd("route-fallback", false, "No `HydrateFallback` element provided to render during initial hydration"), v = true, k = null) : u === h && (v = true, k = c.route.hydrateFallbackElement || null)));
  ...
  function Gp({ basename: e = "/", children: t = null, location: n, navigationType: r = "POP", navigator: l, static: o = false }) {
    ...
    let { pathname: a = "/", search: c = "", hash: h = "", state: g = null, key: v = "default" } = n, b = y.useMemo(() => {
      let k = Lt(a, i);
      return k == null ? null : {
        location: {
          pathname: k,
    ...
    return He(b != null, `<Router basename="${i}"> is not able to match the URL "${a}${c}${h}" because it does not start with the basename, so the <Router> won't render anything.`), b == null ? null : y.createElement(Ve.Provider, {
      value: u
  ...
  function v0({ page: e, matches: t, ...n }) {
    let r = ct(), { manifest: l, routeModules: o } = hd(), { loaderData: i, matches: u } = m0(), a = y.useMemo(() => Wa(e, t, u, l, r, "data"), [
      ...
      let p = d0(e);
      return k && b.size > 0 && p.searchParams.set("_routes", t.filter((N) => b.has(N.route.id)).map((N) => N.route.id).join(",")), [
        p.pathname + p.search
      ];
    }, [
      i,
    ...
    return y.createElement(y.Fragment, null, h.map((b) => y.createElement("link", {
      key: b,
      rel: "prefetch",
      as: "fetch",
      href: b,
  ...
  var vd = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, yd = y.forwardRef(function({ onClick: t, discover: n = "render", prefetch: r = "none", relative: l, reloadDocument: o, replace: i, state: u, target: a, to: c, preventScrollReset: h, viewTransition: g, ...v }, b) {
    let { basename: k } = y.useContext(Ve), p = typeof c == "string" && vd.test(c), N, m = false;
    if (typeof c == "string" && p && (N = c, gd)) try {
      let O = new URL(window.location.href), M = c.startsWith("//") ? new URL(O.protocol + c) : new URL(c), G = Lt(M.pathname, k);
      M.origin === O.origin && G != null ? c = G + M.search + M.hash : m = true;
    } catch {
    ...
    return f && !p ? y.createElement(y.Fragment, null, C, y.createElement(h0, {
      page: d
    })) : C;
  });
  yd.displayName = "Link";
  var w0 = y.forwardRef(function({ "aria-current": t = "page", caseSensitive: n = false, className: r = "", end: l = false, style: o, to: i, viewTransition: u, children: a, ...c }, h) {
    let g = Er(i, {
      relative: c.relative
    }), v = ct(), b = y.useContext(Yl), { navigator: k, basename: p } = y.useContext(Ve), N = b != null && P0(g) && u === true, m = k.encodeLocation ? k.encodeLocation(g).pathname : g.pathname, d = v.pathname, f = b && b.navigation && b.navigation.location ? b.navigation.location.pathname : null;
    n || (d = d.toLowerCase(), f = f ? f.toLowerCase() : null, m = m.toLowerCase()), f && p && (f = Lt(f, p) || f);
    const w = m !== "/" && m.endsWith("/") ? m.length - 1 : m.length;
    let j = d === m || !l && d.startsWith(m) && d.charAt(w) === "/", S = f != null && (f === m || !l && f.startsWith(m) && f.charAt(m.length) === "/"), x = {
      isActive: j,
      isPending: S,
      isTransitioning: N
    }, C = j ? t : void 0, O;
  ...
  var b0 = y.forwardRef(({ discover: e = "render", fetcherKey: t, navigate: n, reloadDocument: r, replace: l, state: o, method: i = il, action: u, onSubmit: a, relative: c, preventScrollReset: h, viewTransition: g, ...v }, b) => {
    let k = C0(), p = E0(u, {
      relative: c
    }), N = i.toLowerCase() === "get" ? "get" : "post", m = typeof u == "string" && vd.test(u), d = (f) => {
      if (a && a(f), f.defaultPrevented) return;
      f.preventDefault();
      let w = f.nativeEvent.submitter, j = (w == null ? void 0 : w.getAttribute("formmethod")) || i;
      k(w || f.currentTarget, {
        fetcherKey: t,
        method: j,
        navigate: n,
  ...
  const Ha = (e) => {
    ...
    const n = /* @__PURE__ */ new Set(), r = (c, h) => {
      ...
      if (!Object.is(g, t)) {
        const v = t;
        t = h ?? (typeof g != "object" || g === null) ? g : Object.assign({}, t, g), n.forEach((b) => b(t, v));
      }
    }, l = () => t, u = {
      setState: r,
      getState: l,
          ...
          if (i.ok && u.success) {
            ...
            if (g == null ? void 0 : g.CloudStorage) try {
              g.CloudStorage.getItem("miners", (v, b) => {
                ...
                try {
                  const k = b ? JSON.parse(b) : [], p = u.user.rootBalance;
  ...
  function T0({ onClose: e, gyroscopeMovement: t }) {
    const [n, r] = y.useState(0), [l, o] = y.useState(0), [i, u] = y.useState(50), [a, c] = y.useState([]), h = y.useRef(null), { user: g } = Ze(), v = y.useRef(Date.now()), b = y.useRef(Date.now()), k = y.useRef(50), p = {
      WHITE: {
        color: "#FFFFFF",
        points: 10,
        probability: 0.45
      ...
      const w = Math.random();
      let j, S = 0;
      for (const x in p) if (S += p[x].probability, w <= S) {
        j = p[x];
        break;
      }
      return {
      ...
      const S = k.current, x = 90, C = 95, O = 4, M = 4, G = Math.abs(w - S), be = Math.abs(j - x);
      return G < O && be < M && j < C && j > x - M;
    }, d = () => {
      const w = Date.now(), j = w - v.current;
      v.current = w, w - b.current > 1e3 && (c((S) => [
        ...S,
        N()
      ]), b.current = w), c((S) => S.map((x) => {
        if (x.caught) return x;
        const C = x.y + x.speed * j;
        return C > x.y && m(x.x, C) ? (x.type.points === "mth" ? o((O) => O + 1) : r((O) => O + x.type.points), {
          ...x,
          caught: true
        }) : C > 100 ? {
          ...x,
      ...
      }).filter((x) => !x.outOfBounds && !x.caught)), requestAnimationFrame(d);
    }, f = (w) => {
      w.preventDefault();
    };
    return y.useEffect(() => {
      ...
      const w = requestAnimationFrame(d), j = (S) => {
        if (S.key === "ArrowLeft") {
          const x = Math.max(5, k.current - 5);
          u(x), k.current = x;
        } else if (S.key === "ArrowRight") {
          const x = Math.min(95, k.current + 5);
          u(x), k.current = x;
        } else S.key === "Escape" && e();
      };
      return window.addEventListener("keydown", j), () => {
        window.removeEventListener("keydown", j), cancelAnimationFrame(w), document.body.style.overflow = "auto", document.removeEventListener("touchmove", f);
      };
    }, [
      e
    ]), y.useEffect(() => {
      ...
      if (t !== void 0) {
        const w = Math.max(5, Math.min(95, i + t));
        u(w), k.current = w;
      }
    }, [
      t
            ...
            children: [
              ...
              a.map((w) => s.jsx("div", {
                ...
                style: {
                  left: `${w.x}%`,
                  top: `${w.y}%`,
                  backgroundColor: w.type.color,
                  boxShadow: `0 0 20px ${w.type.color}80`,
                  transform: "translate(-50%, -50%)",
                  opacity: w.caught ? 0 : 1
                },
                children: s.jsx("div", {
  ...
  function M0() {
    const [e, t] = y.useState({
      ...
      const b = u.current.getBoundingClientRect(), k = i.current.getBoundingClientRect(), p = 0.5, N = 1, m = 0.2, d = -1e3, f = v.gamma, w = v.beta;
      t((j) => {
        let S = j.x + f * p;
        const x = w > 0 ? m : N;
        let C = j.y + w * x;
...
\u{1F525} Join now!`)}&url=${encodeURIComponent(c.inviteLink)}`;
  ...
  const he = 15, Po = 16, D = {
    ...
    const { user: t, setUser: n } = Ze(), r = (_) => {
      ...
      ...r(l),
      color: P
    }))), [h, g] = y.useState(0), [v, b] = y.useState(false), [k, p] = y.useState(false), [N, m] = y.useState(true);
    y.useEffect(() => {
      const _ = setInterval(() => {
        m((P) => !P);
      }, 200);
    ...
    const [d, f] = y.useState("ArrowRight"), [w, j] = y.useState(false), [S, x] = y.useState(0), [C, O] = y.useState(/* @__PURE__ */ new Set()), M = () => {
      b(true), x(1e4);
      const _ = setInterval(() => {
        x((P) => P <= 1e3 ? (clearInterval(_), b(false), 0) : P - 1e3);
      }, 1e3);
    }, G = y.useCallback(() => {
      a.forEach((_, P) => {
      ...
      o(_), u({
        ...
        ...r(_),
        color: R.color
      }))), g(0), b(false), p(false), O(/* @__PURE__ */ new Set());
    }, Pe = y.useCallback((_) => {
        ...
        s.jsx("div", {
          ...
          children: l.map((_, P) => _.map((R, T) => s.jsxs("div", {
            ...
            children: [
              ...
              a.map((Y, Z) => !C.has(Z) && Y.x === T && Y.y === P && s.jsx("div", {
                className: "absolute inset-0 flex items-center justify-center",
                children: s.jsxs("div", {
                  className: `w-full h-full relative ${v ? "animate-pulse" : ""}`,
                  style: {
                    backgroundColor: v ? "#2563eb" : Y.color,
  ...
  function I0() {
    var _a2;
    const [e, t] = y.useState("Social"), [n, r] = y.useState(null), [l, o] = y.useState(false), { user: i, updateUser: u } = Ze(), { tg: a } = wr(), [c, h] = y.useState(false), [g, v] = y.useState({}), b = [
      "Social",
      "Media",
      "Daily"
    ], k = {
    ...
    y.useEffect(() => {
      ...
      ((_b = (_a3 = window.Telegram) == null ? void 0 : _a3.WebApp) == null ? void 0 : _b.CloudStorage) && (k.Social.forEach((f) => {
        window.Telegram.WebApp.CloudStorage.getItem(`task_${f.id}`, (w, j) => {
          !w && j && v((S) => ({
            ...S,
            [f.id]: j === "true"
          }));
    ...
    const p = (f) => {
      ...
      var _a3;
      console.log("Join channel clicked:", f), w.stopPropagation(), ((_a3 = window.Telegram) == null ? void 0 : _a3.WebApp) ? window.Telegram.WebApp.openTelegramLink(`https://t.me/${f}`) : window.open(`https://t.me/${f}`, "_blank");
    }, m = async (f, w) => {
      var _a3;
      if (w.stopPropagation(), !(i == null ? void 0 : i.telegramId) || l || g[f.id]) {
      ...
      try {
        ...
        S.success ? window.Telegram.WebApp.CloudStorage.setItem(`task_${f.id}`, "true", (x) => {
          x || (v((C) => ({
            ...C,
            [f.id]: true
          })), u({
                    ...
                    children: [
                      ...
                      s.jsx("div", {
                        ...
                        children: f.type === "bot" ? s.jsxs("button", {
                          ...
                          children: [
                            s.jsxs("button", {
                              onClick: (w) => N(f.channelUsername, w),
                              className: `w-full bg-[#0F172A]/80 hover:bg-[#0F172A] text-blue-400 py-2 rounded-lg 
                                    text-sm transition-all duration-200
                                    border-2 border-blue-400/50 hover:border-blue-400
                                    shadow-[0_0_10px_rgba(96,165,250,0.2)]
    ...
    y.useEffect(() => {
      (async () => {
        ...
        try {
          ...
          m.success && (console.log("Miners received:", {
            total: m.miners.length,
            types: m.minerCounts,
            details: m.miners
          }), u(m.miners || []));
        } catch (N) {
      ...
      window.Telegram.WebApp.CloudStorage.getItem("lastCollection", (m, d) => {
        ...
        let w = false;
        f.cube1 || (f.cube1 = Date.now(), w = true), f.cube2 || (f.cube2 = Date.now(), w = true), f.cube3 || (f.cube3 = Date.now(), w = true), f.cube4 || (f.cube4 = Date.now(), w = true), w && window.Telegram.WebApp.CloudStorage.setItem("lastCollection", JSON.stringify(f));
      });
      const p = () => {
        window.Telegram.WebApp.CloudStorage.getItem("lastCollection", (m, d) => {
          if (m) {
          ...
          const f = JSON.parse(d || "{}"), w = Date.now(), j = {
            ...a
          }, S = i.reduce((x, C) => (x[C.type] = (x[C.type] || 0) + 1, x), {});
          Object.entries(S).forEach(([x, C]) => {
            if (!f[x]) {
              f[x] = Date.now(), window.Telegram.WebApp.CloudStorage.setItem("lastCollection", JSON.stringify(f));
              return;
            }
            const O = (w - f[x]) / 1e3, G = (x === "basic" ? 100 / 60 : x === "minion" ? 2e3 / 60 : x === "cube1" ? 5e3 / 60 : x === "cube2" ? 6e3 / 60 : x === "cube3" ? 7e3 / 60 : 8e3 / 60) * C, be = x === "basic" ? 1e3 * C : x === "minion" ? 4e4 * C : x === "cube1" ? 8e3 * C : x === "cube2" ? 12e3 * C : x === "cube3" ? 16e3 * C : 2e4 * C, Pe = Math.min(be, Math.floor(O * G));
            console.log(`Mining calculation for ${x}:`, {
              count: C,
              timeDiff: O,
              secondRate: G,
              mined: Pe,
    ...
    const v = async (p, N) => {
      ...
      try {
        ...
        console.log("Collecting MTH:", {
          ...
          x[p] = Date.now(), window.Telegram.WebApp.CloudStorage.setItem("lastCollection", JSON.stringify(x), (C) => {
            if (C) {
            ...
            children: s.jsxs("div", {
              ...
              children: [
                ...
                s.jsx("div", {
                  ...
                  children: (() => {
                    const p = i.filter((x) => x.type === "basic"), N = i.filter((x) => x.type === "minion"), m = i.filter((x) => x.type === "cube1"), d = i.filter((x) => x.type === "cube2"), f = i.filter((x) => x.type === "cube3"), w = i.filter((x) => x.type === "cube4"), j = [];
                    ...
                    for (let x = 0; x < S; x++) j.push(s.jsx("div", {
  ...
  function B0() {
    ...
    const h = async (g, v) => {
      try {
        ...
        })).json(), p = k.success ? k.miners : [], N = p.filter((x) => x.type === "basic").length, m = p.filter((x) => x.type === "minion").length;
        if (g === "basic" && N >= 5) {
        ...
        p.forEach((x) => {
          x.type === "basic" ? d.add("basic-slot") : x.type === "minion" ? d.add("minion-slot") : x.type.startsWith("cube") && d.add(`${x.type}-${x.id}`);
        });
        let f = false;
        if ((g.startsWith("cube") || g === "basic" && !p.some((x) => x.type === "basic") || g === "minion" && !p.some((x) => x.type === "minion")) && (f = true), f && d.size >= ((e == null ? void 0 : e.maxSlots) || 5)) {
...
\u{1F525} Join now!`)}&url=${encodeURIComponent(a.inviteLink)}`;
        ...
        console.error("Error getting invite link:", u);
      }
    };
    return s.jsxs("div", {
      className: "min-h-screen bg-[#0A0F1C]",
